<template>
  <div>
    ...
    >
      <p class="text-gray-600 mb-2">The Most Popular Posts</p>
      <div class="border-b-2 border-gray-700 mb-4 w-72"></div>
      <div
      ...
      >
        <blog-post
          :post="{
            excerpt:
              'Hello to me and all the other people of this fortune. Tell me what you see in this land and then we shall conquer the land',
            image:
    ...
    <div
      class="px-4 py-16 mx-auto sm:max-w-xl md:max-w-full lg:max-w-screen-xl md:px-24 lg:px-8 lg:py-20"
    >
      <p class="text-gray-600 mb-2">The Most Recent Posts</p>
      <div class="border-b-2 border-gray-700 mb-4 w-72"></div>
      <div
